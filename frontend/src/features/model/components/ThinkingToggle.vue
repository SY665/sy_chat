...
<template>
    <button type="button" role="switch"
        ...
        <span aria-hidden="true" class="relative h-4 w-7 shrink-0 overflow-hidden rounded-full transition-colors"
            :class="effectiveThinkingEnabled
                ? 'bg-neutral-950 dark:bg-white'
                : 'bg-neutral-300 dark:bg-neutral-600'">
            <span class="absolute left-0 top-0.5 h-3 w-3 rounded-full transition-transform duration-200" :class="effectiveThinkingEnabled
